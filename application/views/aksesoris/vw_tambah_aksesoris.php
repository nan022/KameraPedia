        			            ...
        			            <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator" method="POST">
        			                <div class="m-portlet__body">
        			                    <div class="form-group m-form__group row">
        			                        ...
        			                        <div class="col-lg-6">
        			                            <input type="text" name="nama" value="<?= set_value('nama') ?>" class="form-control" id="nama" placeholder="Masukan Nama Aksesoris">
        			                        ...
        			                        <div class="m-form__actions m-form__actions--solid">
        			                            <div class="row">
        			                                ...
        			                                <div class="col-lg-6">
        			                                    ...
        			                                    <a href="<?= base_url('Aksesoris') ?>" class="btn btn-secondary">Batal</a>
        			                                </div>
        			                            </div>
        			                        </div>
        			                    </div>
