            ...
            <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator" method="POST">
                <div class="m-portlet__body">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="nama" value="<?= set_value('nama') ?>" class="form-control" id="nama" placeholder="Masukan Nama Kamera">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="jenis" value="<?= set_value('jenis') ?>" class="form-control" id="jenis" placeholder="Masukan Jenis Kamera">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="sensor" value="<?= set_value('sensor') ?>" class="form-control" id="sensor" placeholder="Masukan Sensor">
